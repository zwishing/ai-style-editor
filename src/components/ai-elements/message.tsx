...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:ml-auto group-[.is-user]:w-fit group-[.is-user]:max-w-[90%] group-[.is-user]:rounded-lg group-[.is-user]:bg-secondary group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-foreground",
